...
namespace EmployeeManagement.Test
{
    public class EmployeeServiceTestsWithAspNetCoreDI
        : IClassFixture<EmployeesServiceWithAspNetDIFixture>
    {
        private readonly EmployeesServiceWithAspNetDIFixture
            _employeeServiceFixture;

        public EmployeeServiceTestsWithAspNetCoreDI(
            EmployeesServiceWithAspNetDIFixture employeeServiceFixture)
        {
